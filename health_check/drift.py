...
dict = RedisDict(host="127.0.0.1", port="6379", password="", db=0, expire=timedelta(minutes=1440))
...
def current_status():
    aware_local_now = datetime.now(timezone.utc).astimezone().strftime("%m/%d/%Y-%H:%M")
